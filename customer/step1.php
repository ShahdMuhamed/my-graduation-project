...
if(isset($_POST['submit'])){
    if(empty($_POST['car'])){
        ...
        <strong>you have to select a car!</strong><br> 
    </div> ";
    }else{
        $car_id = $_POST['car'];
    //    echo ($car_id)
        ...
        $_SESSION['car'] = $car_id ; 
        $insert ="INSERT INTO `carts` VALUES(NULL , $user_id , NULL , NULL , $car_id , NULL)";
...
<body>
    ...
    <!--*--------------------------------------------- Step 1 --------------------------------------------->
    <section class="step1 mainBg">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="custom-card">
                        <div class="d-flex align-items-center gap-4">
                            <a href="" class="py-2 px-3 text-black"><i class="fa-solid fa-angle-left fa-xl"></i></a>
                            <div class="mainText">
                                <p class="fw-bold text-capitalize">step-1</p>
                                <h4 class="text-capitalize">select your car</h4>
                            </div>
                        </div>
                        <hr>
                        <form action=""  method="POST" class="d-flex flex-column fw-bold gap-3">
                            <?php foreach($run_select as  $data){?>
                            <div class="border-gray p-3">
                                <input type="radio" id="<?php echo $data['car_id']  ; ?>" name="car" value="<?php echo $data['car_id'] ; ?>" >
                                <label for="<?php echo $data['car_id'] ; ?>"><?php echo $data['name'] .' '. $data['year'] ; ?></label>
                            </div>
                            <?php } ?>
                  
                        <!-- <div class="alert alert-success text-center w-50 m-auto">
                            <strong>Your Car added Successfully.</strong>
                        </div>
                        <div class="alert alert-danger text-center w-50 m-auto">
                            <strong>Wrong Information!</strong><br> Please Check your Information again.
                        </div> -->
                        ...
                        <button class="mt-3 p-3 fs-5 fw-bold carSelected text-white text-center carSelected w-100" name="addcar">Add your Car +</button>
                        </form>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="custom-card">
                        <img src="../images/Forms/reg-img.jpg" alt="carix" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>

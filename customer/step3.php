...
$select = "SELECT * FROM `services` WHERE `type` = 'additional' ORDER BY `s_id` DESC";
...
if(isset($_POST['submit']) || isset($_POST['checkout'])){
    $services = $_POST['additional_service'];
    foreach($services as $service){
        $insert = "INSERT INTO `carts` VALUES(NULL , $user_id , NULL , $service , $car_id , NULL)";
                ...
                <div class="col-lg-7">
                    <div class="custom-card">
                        <div class="d-flex align-items-center gap-4">
                            <a href="./step2.php" class="py-2 px-3 text-black"><i
                                    class="fa-solid fa-angle-left fa-xl"></i></a>
                            <div class="mainText">
                                <p class="fw-bold text-capitalize">step-3</p>
                                <h4 class="text-capitalize">select add-on services</h4>
                                <p class="add">Now You can Continue to the checkout process or select any add-ons</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row justify-content-center gap-4">
                            ...
                            <div class="col-md-5 p-3 border-gray">
                                <div class="form-check d-flex gap-3 align-items-center w-100 justify-content-between">
                                    <input type="checkbox" value="<?php echo $data['s_id'] ; ?>" class="form-check-input cursor-pointer"
                                        id="<?php echo $data['s_id'] ; ?>" name="additional_service[]">
                                    <label for="<?php echo $data['s_id'] ; ?>" class="form-check-label"><?php echo $data['s_name'];?></label>
                                    <div class="box">

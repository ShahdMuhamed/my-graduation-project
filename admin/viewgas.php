...
if(isset($_POST['search'])){
    ...
    WHERE `stations_locations`.`location_address` like '%$text%'
    or `stations_locations`.`location_link` like '%$text%'
    or `stations_city`.`station_city` like '%$text%' or `stations_area`.`area_station_name` like '%$text%'" ;
...
if(isset($_GET['delete'])){
    $id=$_GET['delete'];
    $delete="DELETE FROM `stations_locations` WHERE `location_station_id`=$id";
    ...
    <section class="mainBg py-5">
        <div class="container view">
            ...
            <table>
                ...
                <tr>
                    <td class="text-center"><?php echo $row['station_city'] ?></td>
                    <td class="text-center"><?php echo $row['area_station_name'] ?></td>
                    <td class="text-center"><?php echo $row['location_address'] ?></td>
                    <td class="text-center"><a href="<?php echo $row['location_address'] ?>"><?php echo $row['location_link'] ?></a></td>
                    <td class="update text-center fs-5"><a href="addgas.php?edit=<?php echo $row['location_station_id']; ?>"><i class="fa-solid fa-rotate"></i></a></td>
                    <td class="delete text-center fs-5"><a href="viewgas.php?delete=<?php echo $row['location_station_id']; ?>" onclick="return confirm('Are you sure you want to delete this location?')"><i class="fa-solid fa-trash"></i></a></td>
                </tr>
               <?php } ?>
            </table>
        </div>

...
$run_select = mysqli_query($connect , $select_brand);
...
if(isset($_GET['delete'])){
    ...
    $delete = "DELETE FROM `brands` WHERE `id` = $brand_id";
    $run_delete = mysqli_query($connect , $delete);
    header("location:/projects/carix/admin/viewbrand.php");
}


if(isset($_POST['add'])){
    header("location:/projects/carix/admin/Add-Brand.php");
}
    ...
    <section class="mainBg py-5">
        <div class="container view">
            ...
            <table class="carBrand">
                ...
                <?php foreach($run_select as $brand){ ?>
                <tr>
                    <td><?php echo $brand['name'] ; ?></td>
                    <td class="text-center"><img src="../images/Home/CarBrands/<?php echo $brand['logo'];?>" alt="<?php echo $brand['name'];?>" width="100%"
                            class="img-fluid"></td>
                    <td class="update text-center fs-4"><a href="Add-Brand.php?update=<?php echo $brand['id'] ?>"><i class="fa-solid fa-rotate"></i></a></td>
                    <td class="delete text-center fs-4"><a href="viewbrand.php?delete=<?php echo $brand['id'] ?>"><i class="fa-solid fa-trash"></i></a></td>
                </tr>
                <?php } ?>
            </table>
        </div>

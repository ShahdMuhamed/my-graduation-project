...
//add icon
if(isset($_POST['add'])){
    header("location:/projects/carix/admin/Add-Admin.php");
}
...
if(isset($_POST['search'])){
    ...
    $select="SELECT * FROM `admins` WHERE `role` like '%$text%' or `email` like '%$text%' " ;
    $run_select=mysqli_query($connect,$select);
}elseif(isset($_POST['sort'])){
    $value=$_POST['value'];
    if($value==1)
    {
        $select="SELECT * FROM `admins` ORDER BY `id` ASC";
        $run_select=mysqli_query($connect,$select);
    }else{
...
if(isset($_GET['delete'])){
    ...
    header("location:/projects/carix/admin/viewadmin.php");
}
        ...
        <div class="container view">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="update text-center fs-5"><a href="Add-admin.php?edit=<?php echo $row['id']; ?>"><i class="fa-solid fa-rotate"></i></a></td>
                    <td class="delete text-center fs-5"><a href="viewadmin.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this admin?')"><i class="fa-solid fa-trash"></i></a></td>
                </tr>
                <?php } ?>
            </table>
        </div>

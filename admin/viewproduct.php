...
if(isset($_GET['delete'])){
    ...
    header("location:/projects/carix/admin/viewproduct.php");
}


//header to add product
if(isset($_POST['add'])){
    header("location:/projects/carix/admin/Add-product.php");
}
?>
        ...
        <div class="container view">
            ...
            <table class="product">
                <tr class="table-header">
                    ...
                    <th>Price</th>
                    <th>Image</th>
                    <th class="ps-0 text-center">Quantity</th>
                    <th class="ps-0 text-center">Update</th>
                    <th class="ps-0 text-center">Delete</th>
                </tr>
                <?php foreach($run_select_product as $product){ ?>
                <tr>
                    <td class="serviceName"><?php echo $product['p_name'] ;?></td>
                    <td class="price"><?php echo $product['p_price'] ; ?> EGP</td>
                    <td class="content"><img src="../images/Services/step4/<?php echo $product['image'] ;?>" alt="<?php echo $product['p_name'] ;?>" width="100%"
                            class="img-fluid"></td>
                    <td class="p-0 text-center"><?php echo $product['quantity'];?></td>
                    <td class="update text-center fs-4"><a href="Add-product.php?update=<?php echo $product['p_id'] ?>"><i class="fa-solid fa-rotate"></i></a></td>
                    <td class="delete text-center fs-4"><a href="viewproduct.php?delete=<?php echo $product['p_id'] ?>"><i class="fa-solid fa-trash"></i></a></td>
                </tr>
                <?php } ?>
